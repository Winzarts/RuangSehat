...
class FormArticleScreen extends StatefulWidget {
  ...
  static const String routename = '/form_article';
...
class _FormArticleScreenState extends State<FormArticleScreen> {
  ...
  Future<void> handleSubmit(bool isEdit, String? articleId) async {
    ...
    if (provider.errorMessage == null) {
      SnackbarHelper.show(
        context,
        message: provider.successMessage ?? 'succes',
        isError: false
      );
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  fillColor: AppColors.secondary,
                  filled: true,
                  hintText: 'Masukkan Kategori Artikel Kamu',
                  isDense: true,
                  hintStyle: const TextStyle(
                    color: AppColors.hintText,
                    fontSize: 14,
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  fillColor: AppColors.secondary,
                  filled: true,
                  hintText: 'Masukkan Deskripsi Artikel Kamu',
                  isDense: true,
                  hintStyle: const TextStyle(
                    color: AppColors.hintText,
                    fontSize: 14,
